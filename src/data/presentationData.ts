export const presentationData = {
  ...
  performance: {
    title: "Investimentos",
    description: "Time Deposit e Yankee Certificate of Deposit. Evolução da base ativa de investimentos e clientes, consolidando maior visibilidade operacional e capacidade de gestão do portfólio ao longo do período.",
    chartData: [
      { period: "Jan-Ago 2022", investments: 1.20, clients: 38 },
      { period: "Set-Dez 2022", investments: 2.46, clients: 50 },
      { period: "31/12/2023", investments: 16.55, clients: 146 },
      { period: "31/12/2024", investments: 11.33, clients: 169 },
      { period: "31/12/2025", investments: 6.36, clients: 179 },
      { period: "30/04/2026", investments: 1.79, clients: 131 },
    ],
